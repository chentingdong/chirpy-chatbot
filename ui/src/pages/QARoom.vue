          ...
          <div class="col-3 sidebar api-input-wrapper">
              ...
              <div class="content">
                  ...
                  <p>
                    ...
                    <input type="text" name="agent_id" v-model="agentId" placeholder="Agent ID"/>
                  </p>
                  <h3>user info:</h3>
                  <p>
                  ...
                  <p>
                    ...
                    <table>
                      <tr>
                        <td><input type="radio" name="germany" value="Germany" v-model="country"></td>
                        <td>Germany</td>
                      </tr>
                      <tr>
                        <td><input type="radio" name="usa" value="United States of America" v-model="country"></td>
                        <td>United States of America</td>
                      </tr>
                      <tr>
                        <td>Or type it here: </td>
                        <td><input type="text" name="other_country" v-model="country"/></td>
                      </tr>
                    </table>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <input type="text" name="instance_name" v-model="instanceName" placeholder="ServiceNow Instance Name" />
                  </p>
              </div>
          </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      url: null,
      me: null,
      agentId: this.$route.params.agentId || 1,
